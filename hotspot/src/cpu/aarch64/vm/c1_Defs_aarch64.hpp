...
enum {
  ...
  pd_nof_caller_save_cpu_regs_frame_map = 19 - 2 R18_RESERVED_ONLY(- 1 /* r18 */),  // number of registers killed by calls
  pd_nof_caller_save_fpu_regs_frame_map = 32,  // number of registers killed by calls

  pd_first_callee_saved_reg = 19 - 2 R18_RESERVED_ONLY(- 1 /* r18 */),
  pd_last_callee_saved_reg = 26 - 2 R18_RESERVED_ONLY(- 1 /* r18 */),

  pd_last_allocatable_cpu_reg = 16 R18_RESERVED_ONLY(- 1 /* r18 */),
  ...
  pd_first_cpu_reg = 0,
  pd_last_cpu_reg = 16 R18_RESERVED_ONLY(- 1 /* r18 */),
  pd_first_byte_reg = 0,
  pd_last_byte_reg = 16 R18_RESERVED_ONLY(- 1 /* r18 */),
