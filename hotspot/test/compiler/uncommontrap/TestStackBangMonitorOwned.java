 ...
 * @run main/othervm -XX:-BackgroundCompilation -XX:CompileCommand=dontinline,TestStackBangMonitorOwned::m1 -XX:CompileCommand=exclude,TestStackBangMonitorOwned::m2 -Xss768K -XX:-UseOnStackReplacement TestStackBangMonitorOwned
 *
 */
