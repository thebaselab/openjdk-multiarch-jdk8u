 ...
 * @run main/othervm -XX:-BackgroundCompilation -XX:CompileCommand=dontinline,TestStackBangRbp::m1 -XX:CompileCommand=exclude,TestStackBangRbp::m2 -Xss768K -XX:-UseOnStackReplacement TestStackBangRbp
 *
 */
